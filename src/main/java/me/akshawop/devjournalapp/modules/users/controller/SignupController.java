package me.akshawop.devjournalapp.modules.users.controller;
...
import me.akshawop.devjournalapp.modules.users.service.OTPService;
import me.akshawop.devjournalapp.modules.users.service.UserService;
...
public class SignupController {
    ...
    public ResponseEntity<HttpStatus> signup(@Validated(UserDTO.OnSignup.class) @RequestBody UserDTO userData) {
        ...
        EmailJob job = EmailJobs.getOTPVerificationMail(userData.getEmail(), otp);
