...
import me.akshawop.devjournalapp.modules.users.exception.UserNotFoundException;
import me.akshawop.devjournalapp.modules.users.exception.UsernameAlreadyTakenException;
import me.akshawop.devjournalapp.modules.users.infrastruture.email.EmailJobs;
...
import me.akshawop.devjournalapp.modules.users.repository.entity.UserRoles;
import me.akshawop.devjournalapp.modules.users.util.GenerateUsername;
import me.akshawop.devjournalapp.shared.service.QueueService;
...
public class UserService {
    ...
    public User saveNewUser(@NonNull UserDTO userData) {
        ...
        EmailJob job = EmailJobs.getSignupSuccessMail(user);
